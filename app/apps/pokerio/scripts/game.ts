import { PointerMesh } from "../classes/pointerMesh";
...
import { CardTextureManager } from "../classes/textureManager";
import { Socket } from "../classes/socket.io";
// import { GUI } from "dat.gui";
import { BoardManager } from "../classes/boardManager";
import { LocalPlayer, OnlinePlayer } from "../classes/player";
...
export const urls: loadedURLS = {
    green: "/apps/pokerio/textures/green500x500.png",
    google: "/apps/pokerio/textures/google.png",
    skeleton: "/apps/pokerio/fbx/endy-rigged.fbx",
    roboto: "/apps/pokerio/fonts/Roboto_Bold.typeface.json",
};

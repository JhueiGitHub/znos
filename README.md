...
Add the following object in the theme.extend.colors section of your tailwind.config.js file this config enable sidebar related style utilities like bg-sidebar
